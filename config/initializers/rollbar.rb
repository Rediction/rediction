module Rollbar
  ...
  CLIENT_ENABLED = ENV["ROLLBAR_CLIENT_ENABLED"] || false # クライアントサイド（jsエラー）のチェック（デフォルト無効）
...
Rollbar.configure do |config|
  ...
  config.access_token = Rollbar::SERVER_ACCESS_TOKEN
  ...
  config.environment = Rollbar::ENVIRONMENT
end
